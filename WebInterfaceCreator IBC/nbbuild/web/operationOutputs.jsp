...
<html >
    ...
    <% 
Integer i ; 
if (null == session.getAttribute("numberoutputs")){
    
    i=0;
session.setAttribute("numberoutputs",i) ;}
else{
       i= (Integer)session.getAttribute("numberoutputs");
       i++;
        session.setAttribute("numberoutputs",i);
        }
...
<div class="stepwizard">
  ...
  <form id="contact" action="operationoutputs" method="get">
    <h3>paramétre de sortie (<% out.print(i);%>)</h3>
    <h4>veuillez introduire un paramétre de sortie </h4>
