...
<html >
    ...
    <% 
Integer i ; 
if (null == session.getAttribute("numberpostcond")){
    
    i=0;
session.setAttribute("numberpostcond",i) ;}
else{
       i= (Integer)session.getAttribute("numberpostcond");
       i++;
        session.setAttribute("numberpostcond",i);
        }
...
<div class="stepwizard">
    <div class="stepwizard-row">
        ...
        <div class="stepwizard-step">
         ...
         <div class="stepwizard-step">
            ...
            <p>postconditions   (<% out.print(i);%>)</p>
        </div> 
  ...
  <form id="contact" action="PostConditions" method="get">
    <h3>post-conditions (<% out.print(i);%>)</h3>
    <h4>veuillez introduire une postcondition </h4>

    <fieldset>
      <input placeholder="nom de la post-condition" type="text" tabindex="1" name="name" required autofocus>
    </fieldset>

    <fieldset>
      <input placeholder="contenu de la post-condition" type="text" tabindex="2" name="type" required autofocus>
    </fieldset>
